...
const works = [
  ...
  },
  {
    ...
    description:
      "I made this as a project to the bootcamp I was attending. We were asked to create an app where admins (the users) can manage the bank's clients' financial transactions.",
  ...
  },
  {
    ...
    description:
      'A simple fully functional chess game using React.js and Tailwindcss',
